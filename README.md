# Система мониторинга компьютерного клуба

Этот проект реализует систему для отслеживания работы компьютерного клуба, обработки событий и расчета выручки. Программа читает входные данные из файла, обрабатывает события в хронологическом порядке и выводит результаты работы.
